...
function createTemplateCard(template, templatesMode) {
    ...
    return `
        <a data-cy="template-card-link" href="${href}" class="block bg-white rounded-2xl shadow-soft overflow-hidden hover:shadow-lg transition-shadow cursor-pointer group">
